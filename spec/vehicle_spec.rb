...
describe('Vehicle') do
  ...
  describe("#make") do
    it("returns the make of the vehicle") do
      test_vehicle = Vehicle.new(helpful_hash)
  ...
  describe("#engine_size") do
    it("returns the size of the vehicle") do
      test_vehicle = Vehicle.new(helpful_hash)
      expect(test_vehicle.engine_size()).to(eq("4L"))
    end
  end
  describe("#number_of_doors") do
    it("returns the doors of the vehicle") do
      test_vehicle = Vehicle.new(helpful_hash)
 ...
 describe(".clear") do
  ...
  describe(".find") do
    it("returns a vehicle by its id number") do
      test_vehicle = Vehicle.new(helpful_hash)
      test_vehicle.save()
      test_vehicle2 = Vehicle.new(helpful_hash)
      test_vehicle2.save()
